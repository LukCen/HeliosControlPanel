...
// /**
//  * A utility function for creating BrowserWindows in a single line, to avoid code sprawl.
//  * 
//  * @param {number} width - width of the created window in pixels
//  * @param {number} height - height of the created window in pixels
//  * @param {string} winFile - link the HTML file with the window's contents
//  * @param {string[]} pathToPreload - what preload file the window is meant to use - likely stored as an object in main
//  * @param {BrowserWindow} parent - if present, makes the new window a child of whatever element is passed here
//  * @returns no return value, triggers window creation
//  */
// const createNewWindow = (width: number,
//   height: number,
//   winFile: string,
//   pathToPreload: string[],
//   parent: BrowserWindow | null
// ): void => {
//   console.log(`%cfilename: ${__filename}, dirname: ${__dirname}`, `;background: lightblue; color: #f5f5f5`)

//   // if no parent was passed - will create a regular window
//   if (parent === null) {
...
//   } else {
//     // if parent was passed - will create a child window
//     const win: BrowserWindow = new BrowserWindow({
//       width: width,
//       height: height,
//       webPreferences: {
